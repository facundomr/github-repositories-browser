...
import com.facundomr.github.browser.ui.RepositoriesViewModel
...
class PaginationDataSource(val username: String) : PageKeyedDataSource<String, ReposByUserQuery.Node>() {
    ...
    val networkState = MutableLiveData<RepositoriesViewModel.RepositoriesViewState>()

    override fun loadInitial(
        params: LoadInitialParams<String>,
        callback: LoadInitialCallback<String, ReposByUserQuery.Node>) {

        networkState.postValue(RepositoriesViewModel.RepositoriesViewState.SEARCHING)
        ...
        GlobalScope.launch {
            ...
            networkState.postValue(RepositoriesViewModel.RepositoriesViewState.OK)
        }
    }
